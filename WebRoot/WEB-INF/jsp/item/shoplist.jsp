        ...
        <c:forEach items="${pagers.datas}" var="data" varStatus="l">
            <li>
                ...
                <div class="wCa">
                    ...
                    <div class="wCa3" >
                        <button type="button" class="btn" style="cursor: pointer" onclick="outWinIt()">
                            <font>分享</font>
                            <b><img src="${ctx}/resource/user/images/share1.png" alt=""></b>
                        </button>
                        <div class="outWin" id="outWin" style="z-index: 2;">
                            <button  type="button"  style="cursor: pointer" class="close" onclick="closeIt()">关闭</button>

                            <div class="weixin">
                                <button type="button" class="btn" style="cursor: pointer" onclick="outWinIt2()">
                                    <img src="${ctx}/resource/user/images/weichat.png" alt="" >
                                </button>

                            </div>
                        </div>
                        <!-- 二次弹窗 -->
                        <div class="outWin a" id="outWin2" style="z-index: 3;">
                            <button  type="button"  class="close" onclick="closeIt2()">关闭</button>
                            <div class="a">
                                <img src="${ctx}/resource/user/images/ewm.png" alt="">
                            </div>
                        </div>
                        <script>
                            function outWinIt(){console.log('1')
                                document.getElementById('outWin').style.display = "block"
                                // let a.style.display = 'block'
                            }
                            function closeIt(){

                                document.getElementById('outWin').style.display = "none"
                            }
                            function outWinIt2(){console.log('1')
                                document.getElementById('outWin2').style.display = "block"
                                // let a.style.display = 'block'
                            }
                            function closeIt2(){
                                document.getElementById('outWin').style.display = "none"
                                document.getElementById('outWin2').style.display = "none"
                            }
                        </script>
                    </div>
